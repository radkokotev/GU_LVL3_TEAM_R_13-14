...
public class Minimax_Test1 {
	 ...
	 */
	@Test
	public void testMinimaxProblem1() throws FileNotFoundException, CheckFailException {
	...
	@Test 
	public void testMinimaxProblem2() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory + 
				"/src/test/test_data/problem2_unsettled3_2");
		board.setToPlayNext(Stone.WHITE);
		MinimaxGoSolver solver = new MinimaxGoSolver(board, board.getCellAt(9, 1));
		assertEquals(Stone.BLACK, board.getCellAt(9, 1).getContent());
		assertEquals(new GoCell(Stone.WHITE, 9, 0), solver.minimaxDecision());
	}
	
	@Test
	public void testMinimaxProblem3() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory +
	...
	@Test
	public void testMinimaxProblem5() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory +
				"/srs/test/test_data/problem5_rabbitysix_1");
		board.setToPlayNext(Stone.WHITE);
		...
		assertEquals(new GoCell(Stone.WHITE, 5, 1), solver.minimaxDecision());
	}
	
	@Test
	public void testMinimaxProblem6() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory +
				"/srs/test/test_data/problem6_shortageofliberties_1");
		board.setToPlayNext(Stone.WHITE);
	...
	@Test
	public void testMinimaxProblem7() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory +
				"/srs/test/test_data/problem7_interioreye_1");
		board.setToPlayNext(Stone.WHITE);
	...
	@Test
	public void testMinimaxProblem8() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory +
				"/srs/test/test_data/problem8_falseeyes_1");
		board.setToPlayNext(Stone.BLACK);
		MinimaxGoSolver solver = new MinimaxGoSolver(board, board.getCellAt(16, 15));
	...
	@Test
	public void testMinimaxProblem9() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory +
				"/srs/test/test_data/problem9_doorgroup_1");
		board.setToPlayNext(Stone.WHITE);
		MinimaxGoSolver solver = new MinimaxGoSolver(board, board.getCellAt(17, 9));
		assertEquals(Stone.BLACK, board.getCellAt(17, 9).getContent());
		assertEquals(new GoCell(Stone.WHITE, 16, 8), solver.minimaxDecision());
	}
	
	@Test
	public void testMinimaxProblem10() throws FileNotFoundException, CheckFailException {
		GoPlayingBoard board = new GoPlayingBoard(workspaceDirectory +
				"/srs/test/test_data/problem10_incompleteshapes_1");
		board.setToPlayNext(Stone.WHITE);
		MinimaxGoSolver solver = new MinimaxGoSolver(board, board.getCellAt(14, 1));
		assertEquals(Stone.BLACK, board.getCellAt(14, 1).getContent());
		assertEquals(new GoCell(Stone.WHITE, 14, 0), solver.minimaxDecision());
